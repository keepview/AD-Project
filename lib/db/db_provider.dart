...
import 'package:todo/component/iconpicker/ant-icon.dart';
...
class DBProvider {
  ...
  var todos = [
    Todo("Plan", parent: '1',),
    Todo("Unit", parent: '1',),
    Todo("Creative", parent: '1', isCompleted: 1),
    Todo("User Manage", parent: '2',),
    Todo("Accunt Manage", parent: '2',),
    Todo("Authority Manage", parent: '2',),
    Todo("Update Plan", parent: '3',),
  ];

  var tasks = [
    Task('IMP', id: '1',  color: Colors.purple.value, codePoint: AntIcons.imp.codePoint),
    Task('AMS', id: '2', color: Colors.pink.value, codePoint: AntIcons.ams.codePoint),
    Task('Alarm', id: '3', color: Colors.pink.value, codePoint: Icons.alarm.codePoint),
  ];
